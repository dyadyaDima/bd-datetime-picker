    ...
    return (
      <div className="calendar-years" style={style}>
        <div className="calendar-nav">
          <button type="button" className="arrow prev" onClick={this.changePeriod.bind(this, 'prev')} />
          <span className="current-date disabled">{firstYear} - {firstYear + 9}</span>
          <button type="button" className="arrow next" onClick={this.changePeriod.bind(this, 'next')} />
        </div>
        <table>
          <tbody>
